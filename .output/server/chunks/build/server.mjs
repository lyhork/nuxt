...
const _routes = [
  {
    ...
    component: () => import('./create-post.vue.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./list-of-posts.vue.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
...
export { _export_sfc as _, useRouter as a, useRoute as b, useNuxtApp as c, asyncDataDefaults as d, createError as e, fetchDefaults as f, __nuxt_component_0 as g, nuxtLinkDefaults as h, navigateTo as n, resolveRouteObject as r, server as s, tryUseNuxtApp as t, useRuntimeConfig as u };
